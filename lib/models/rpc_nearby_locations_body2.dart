class RpcNearbyLocationsBody2 {
  ...
  static List<RpcNearbyLocationsBody2> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<RpcNearbyLocationsBody2>()
        : json
            .map((value) => new RpcNearbyLocationsBody2.fromJson(value))
            .toList();
  }

  static Map<String, RpcNearbyLocationsBody2> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, RpcNearbyLocationsBody2>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new RpcNearbyLocationsBody2.fromJson(value));
    }
    return map;
  }
}
