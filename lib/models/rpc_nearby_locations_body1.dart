...
class RpcNearbyLocationsBody1 {
  ...
  static List<RpcNearbyLocationsBody1> listFromJson(List<dynamic> json) {
    return json == null ? new List<RpcNearbyLocationsBody1>() : json.map((value) => new RpcNearbyLocationsBody1.fromJson(value)).toList();
  }

  static Map<String, RpcNearbyLocationsBody1> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, RpcNearbyLocationsBody1>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new RpcNearbyLocationsBody1.fromJson(value));
    }
    return map;
  }
}
